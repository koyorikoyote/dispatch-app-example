...
export function SubmissionDetailDialog({ visible, submission, onClose }: SubmissionDetailDialogProps) {
    ...
    const renderGridRow = (fields: Array<{ label: string; value: any }>) => {
            ...
            <View style={styles.gridRow}>
                {validFields.map((field, index) => (
                    <View key={index} style={styles.gridCell}>
                        ...
                        <Text style={valueStyle}>{String(field.value)}</Text>
                    </View>
                ))}
            </View>
        )
            ...
            case "inquiries": {
                ...
                return (
                    <>
                        ...
                        <View style={sectionStyle}>
                            {renderGridRow([
                                { label: t("notifications.detailDialog.dateOfInquiry"), value: formatDateToYYYYMMDD(inquiry.dateOfInquiry) },
            ...
            case "daily_record": {
                ...
                return (
                    <>
                        ...
                        <View style={sectionStyle}>
                            {renderGridRow([
                                { label: t("notifications.detailDialog.date"), value: formatDateToYYYYMMDD(daily.dateOfRecord) },
                    ...
                    <>
                        ...
                        <View style={sectionStyle}>
                            {renderGridRow([
                                ...
                                { label: t("notifications.detailDialog.date"), value: formatDateToYYYYMMDD(interaction.date) },
                            ])}
                            {renderGridRow([
            ...
            case "complaint_details": {
                ...
                return (
                    <>
                        ...
                        <View style={sectionStyle}>
                            {renderGridRow([
                                { label: t("notifications.detailDialog.dateOfOccurrence"), value: formatDateToYYYYMMDD(complaint.dateOfOccurrence) },
                    ...
                    <View style={headerStyle}>
                        <View style={styles.headerLeft}>
                            <Text style={titleStyle}>
                                {getTableDisplayName(submission.tableName)}
                            </Text>
                        </View>
                        <TouchableOpacity
